...
const PERM_STRINGS = ["CREATE_INSTANT_INVITE", "KICK_MEMBERS",                   // 0, 1
                      "BAN_MEMBERS", "ADMINISTRATOR",                            // 2, 3
                      "MANAGE_CHANNELS", "MANAGE_GUILD",                         // 4, 5
                      "ADD_REACTIONS", "VIEW_AUDIT_LOG",                         // 6, 7
                      "PRIORITY_SPEAKER", "STREAM",                              // 8, 9
                      "VIEW_CHANNEL", "SEND_MESSAGES",                           // 10, 11
                      "SEND_TTS_MESSAGES", "MANAGE_MESSAGES",                    // 12, 13
                      "EMBED_LINKS", "ATTACH_FILES",                             // 14, 15
                      "READ_MESSAGE_HISTORY", "MENTION_EVERYONE",                // 16, 17
                      "USE_EXTERNAL_EMOJIS", "VIEW_GUILD_INSIGHTS",              // 18, 19
                      "CONNECT", "SPEAK",                                        // 20, 21
                      "MUTE_MEMBERS", "DEAFEN_MEMBERS",                          // 22, 23
                      "MOVE_MEMBERS", "USE_VAD",                                 // 24, 25
                      "CHANGE_NICKNAME", "MANAGE_NICKNAMES",                     // 26, 27
                      "MANAGE_ROLES", "MANAGE_WEBHOOKS",                         // 28, 29
                      "MANAGE_EMOJIS_AND_STICKERS", "USE_APPLICATION_COMMANDS",  // 30, 31
                      "REQUEST_TO_SPEAK", "UNUSED",                              // 32, 33
					  "MANAGE_THREADS", "CREATE_PUBLIC_THREADS",                 // 34, 35
					  "CREATE_PRIVATE_THREADS", "USE_EXTERNAL_STICKERS",         // 36, 37
					  "SEND_MESSAGES_IN_THREADS", "START_EMBEDDED_ACTIVITIES",]  // 38, 39
