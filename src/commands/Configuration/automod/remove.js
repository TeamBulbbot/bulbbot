...
module.exports = async (client, message, args) => {
	...
	if (!part)
		return message.channel.send(
			await client.bulbutils.translate("automod_missing_punishment", message.guild.id, {
				arg: part,
	...
	if (error === 1) return message.channel.send(await client.bulbutils.translate("automod_not_already_in_database", message.guild.id));
