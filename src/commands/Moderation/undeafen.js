...
module.exports = class extends Command {
	...
	async run(message, args) {
		...
		if (!target.voice.serverDeaf) return message.channel.send(await this.client.bulbutils.translate("undeafen_not_deaf"));
		...
		return message.channel.send(
			await this.client.bulbutils.translate("undeafen_success", {
				target_tag: target.user.tag,
				target_id: target.user.id,
				reason,
				infractionId: infId,
