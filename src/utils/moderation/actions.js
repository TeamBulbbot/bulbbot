...
module.exports = {
	Warn: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		await SendModAction(client, guild, await Utils.translate("action_warn"), target.user, moderator, reasonLog, infId);
	...
	Mute: async (client, guild, target, moderator, reason, reasonLog, muteRole, until) => {
		...
		await SendModActionTemp(client, guild, await Utils.translate("action_mute"), target.user, moderator, reasonLog, infId, until);
	...
	UnmuteManual: async (client, guild, target, moderator, reason, reasonLog, muteRole) => {
		...
		await SendModAction(client, guild, await Utils.translate("action_unmute"), target.user, moderator, reasonLog, infId);
	...
	Unmute: async (client, guild, target, moderator, reason, reasonLog, muteRole) => {
		await guild.member(target.id).roles.remove(muteRole);
		const infId = await createInfraction(guild.id, "Unmute", "true", reasonLog, target.user.tag, target.user.id, moderator.tag, moderator.id);
		await SendAutoUnban(client, guild, await Utils.translate("action_unmute_auto"), target.user, moderator, reasonLog, infId);
	...
	Kick: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		await SendModAction(client, guild, await Utils.translate("action_kick"), target, moderator, reasonLog, infId);
	...
	Ban: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		await SendModAction(client, guild, await Utils.translate("action_ban"), target, moderator, reasonLog, infId);
	...
	TempBan: async (client, guild, target, moderator, reason, reasonLog, until) => {
		...
		await SendModActionTemp(client, guild, await Utils.translate("action_ban_temp"), target, moderator, reasonLog, infId, until);
	...
	ForceBan: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		await SendModAction(client, guild, await Utils.translate("action_ban_force"), target, moderator, reasonLog, infId);
	...
	Unban: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		await SendModAction(client, guild, await Utils.translate("action_unban"), target, moderator, reasonLog, infId);
	...
	UnbanTemp: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		await SendAutoUnban(client, guild, await Utils.translate("action_unban_auto"), target, moderator, reasonLog, infId);
	...
	Deafen: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		await SendModAction(client, guild, await Utils.translate("action_deafen"), target.user, moderator, reasonLog, infId);
	...
	Undeafen: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		await SendModAction(client, guild, await Utils.translate("action_undeafen"), target.user, moderator, reasonLog, infId);
	...
	Voicekick: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		await SendModAction(client, guild, await Utils.translate("action_kick_voice"), target.user, moderator, reasonLog, infId);
