...
export default class {
	...
	async getConfig(guildID: Snowflake): Promise<object> {
		const response: object = await sequelize.query(
			'SELECT * FROM "guildConfigurations" WHERE id = (SELECT "guildConfigurationId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { GuildID: guildID },
	...
	async getPrefix(guildId: Snowflake) {
		const response: object = await sequelize.query(
			'SELECT "prefix" FROM "guildConfigurations" WHERE id = (SELECT "guildConfigurationId" FROM guilds WHERE "guildId" = $GuilID)',
			{
				bind: { GuildID: guildId },
				type: QueryTypes.SELECT,
			},
	...
	async getPremium(guildID: Snowflake): Promise<boolean> {
		const response: object = await sequelize.query(
			'SELECT "premiumGuild" FROM "guildConfigurations" WHERE id = (SELECT "guildConfigurationId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { GuildID: guildID },
				type: QueryTypes.SELECT,
			},
	...
	async setPremium(guildID: Snowflake, premium: boolean): Promise<void> {
		await sequelize.query(
			'UPDATE "guildConfigurations" SET "premiumGuild" = $Premium WHERE id = (SELECT "guildConfigurationId" FROM guilds WHERE "guildId" = $GuildID)',
			{
	...
	async getMuteRole(guildID: Snowflake): Promise<Snowflake | null> {
		const response = await sequelize.query(
			'SELECT "muteRole" FROM "guildConfigurations" WHERE id = (SELECT "guildConfigurationId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { GuildID: guildID },
				type: QueryTypes.SELECT,
			},
	...
	async getAutoRole(guildID: Snowflake): Promise<Snowflake | null> {
		const response = await sequelize.query(
			'SELECT "autorole" FROM "guildConfigurations" WHERE id = (SELECT "guildConfigurationId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { GuildID: guildID },
				type: QueryTypes.SELECT,
			},
	...
	async setLanguage(guildID: Snowflake, language: string): Promise<void> {
		await sequelize.query(
			'UPDATE "guildConfigurations" SET language = $Lang WHERE id = (SELECT "guildConfigurationId" FROM guilds WHERE "guildId" = $GuildID)',
			{
	...
	async getTimezone(guildID: Snowflake): Promise<string> {
		const response: object = await sequelize.query(
			'SELECT timezone FROM "guildConfigurations" WHERE id = (SELECT "guildConfigurationId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { GuildID: guildID },
				type: QueryTypes.SELECT,
			},
	...
	async setTimezone(guildID: Snowflake, timezone: string): Promise<void> {
		await sequelize.query(
			'UPDATE "guildConfigurations" SET timezone = $TZ WHERE id = (SELECT "guildConfigurationId" FROM guilds WHERE "guildId" = $GuildID)',
			{
	...
	async setModAction(guildID: Snowflake, channelID: Snowflake | null): Promise<void> {
		await sequelize.query(
			'UPDATE "guildLoggings" SET "modAction" = $ChannelID WHERE id = (SELECT "guildLoggingId" FROM guilds WHERE "guildId" = $GuildID)',
			{
	...
	async setAutoMod(guildID: Snowflake, channelID: Snowflake | null): Promise<void> {
		await sequelize.query(
			'UPDATE "guildLoggings" SET automod = $ChannelID WHERE id = (SELECT "guildLoggingId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { ChannelID: channelID, GuildID: guildID },
				type: QueryTypes.UPDATE,
			},
	...
	async setMessage(guildID: Snowflake, channelID: Snowflake | null): Promise<void> {
		await sequelize.query(
			'UPDATE "guildLoggings" SET message = $ChannelID WHERE id = (SELECT "guildLoggingId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { ChannelID: channelID, GuildID: guildID },
				type: QueryTypes.UPDATE,
			},
	...
	async setRole(guildID: Snowflake, channelID: Snowflake | null): Promise<void> {
		await sequelize.query(
			'UPDATE "guildLoggings" SET role = $ChannelID WHERE id = (SELECT "guildLoggingId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { ChannelID: channelID, GuildID: guildID },
				type: QueryTypes.UPDATE,
			},
	...
	async setMember(guildID: Snowflake, channelID: Snowflake | null): Promise<void> {
		await sequelize.query(
			'UPDATE "guildLoggings" SET member = $ChannelID WHERE id = (SELECT "guildLoggingId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { ChannelID: channelID, GuildID: guildID },
				type: QueryTypes.UPDATE,
			},
	...
	async setChannel(guildID: Snowflake, channelID: Snowflake | null): Promise<void> {
		await sequelize.query(
			'UPDATE "guildLoggings" SET channel = $ChannelID WHERE id = (SELECT "guildLoggingId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { ChannelID: channelID, GuildID: guildID },
				type: QueryTypes.UPDATE,
			},
	...
	async setJoinLeave(guildID: Snowflake, channelID: Snowflake | null): Promise<void> {
		await sequelize.query(
			'UPDATE "guildLoggings" SET "joinLeave" = $ChannelID WHERE id = (SELECT "guildLoggingId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { ChannelID: channelID, GuildID: guildID },
				type: QueryTypes.UPDATE,
			},
	...
	async getLoggingConfig(guildID: Snowflake): Promise<object> {
		const response: object[] = await sequelize.query(
			'SELECT * FROM "guildLoggings" WHERE id = (SELECT "guildLoggingId" FROM guilds WHERE "guildId" = $GuildID)',
			{
				bind: { GuildID: guildID },
				type: QueryTypes.SELECT,
			},
