...
export const AutoMod_INVITE: RegExp = /(?:https?:\/\/)?(?:www\.)?discord(?:\.gg|\.me|\.com|(?:app)?)?\/(invite\/)?(?!(partners|verification|download))([A-z0-9-_]+)/gi; ///(?:https?:\/\/)?(?:www\.)?discord(?:\.gg|\.me|(?:app)?\.com\/invite)\/([A-Za-z0-9-]+)/g;
