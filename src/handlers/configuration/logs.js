...
module.exports = {
	...
	Change_Message: async (client, guildId, channelId) => {
		...
		sendEmbed(client, channelId, "This channel is setup to log message updates");
	},
	...
	Change_Channel: async (client, guildId, channelId) => {
		...
		sendEmbed(client, channelId, "This channel is setup to log channel changes");
	},
	Change_Join_Leave: async (client, guildId, channelId) => {
		...
		sendEmbed(client, channelId, "This channel is setup to log join leave logs");
	},
};
