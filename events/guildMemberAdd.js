...
module.exports = async (client, user) => {
	...
	SendLog.Join_leave_log(client, user.guild.id, `New user joined the guild **${user.user.username}**#${user.user.discriminator} \`\`(${user.user.id})\`\` - **Account Age:** ${Math.floor(accountAgeInDays).toString().replace("-", "")} days`, "");
};
